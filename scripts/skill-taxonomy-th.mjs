...
export const TECHNICAL_SKILLS = [
  ...
  /* "ประสานงาน" ย้ายไปเป็นทักษะเชิงพฤติกรรม — การประสานงานข้ามฝ่ายผลิต/QA/จัดซื้อ
     เป็นความสามารถคนละอย่างกับงานเอกสาร และเคยดันหมวดนี้ขึ้นไปถึง 44.7% อย่างผิดฝาผิดตัว */
  { name: "งานธุรการและเอกสาร", category: "บัญชีและการเงิน", patterns: ["ธุรการ", "งานเอกสาร", "จัดเก็บเอกสาร", "จัดทำเอกสาร", en("Admin"), en("Administrative"), en("Documentation"), en("Clerical")] },
  ...
  { name: "ระบบไฟฟ้าและอิเล็กทรอนิกส์", category: "การผลิตและวิศวกรรม", patterns: ["ไฟฟ้า", "อิเล็กทรอนิกส์", "ช่างไฟ", "ระบบไฟ", en("Electrical"), en("Electronic")] },
  /* แยก PLC และระบบควบคุมออกจากงานไฟฟ้าทั่วไป เพราะเป็นทักษะคนละระดับ
     ช่างไฟเดินสายไม่ได้แปลว่าเขียน ladder logic หรือตั้งค่า inverter ได้
     และเป็นทักษะที่หลักสูตรวิศวกรรมสอนได้ตรง จึงควรนับแยกให้เห็นอุปสงค์จริง */
  { name: "ระบบอัตโนมัติ PLC และการควบคุม", category: "การผลิตและวิศวกรรม", patterns: ["ระบบอัตโนมัติ", "ควบคุมอัตโนมัติ", "ระบบควบคุม", "อินเวอร์เตอร์", "หุ่นยนต์", "เซนเซอร์", "เซ็นเซอร์", en("PLC"), en("SCADA"), en("HMI"), en("DCS"), en("Inverter"), en("Servo"), en("Automation"), en("Robotics"), en("Ladder")] },
  ...
  /* ห้ามใช้ "สิ่งแวดล้อม" ลอย ๆ เพราะไปตรงกับข้อความแนะนำบริษัท
     เช่น "บรรจุภัณฑ์เพื่อสิ่งแวดล้อม" ซึ่งไม่ใช่ทักษะที่ตำแหน่งนั้นต้องการ */
  { name: "ความปลอดภัยและอาชีวอนามัย", category: "การผลิตและวิศวกรรม", patterns: ["ความปลอดภัย", "จป\\.", "อาชีวอนามัย", "งานด้านสิ่งแวดล้อม", en("Safety"), en("Occupational health"), en("EHS")] },
...
export const SOFT_SKILLS = [
  ...
  { name: "การประสานงานข้ามหน่วยงาน", category: "ทักษะเชิงพฤติกรรม", patterns: ["ประสานงาน", "ติดต่อประสาน", en("Coordination"), en("Coordinate"), en("Liaise")] },
